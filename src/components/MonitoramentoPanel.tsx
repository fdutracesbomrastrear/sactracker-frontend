...
import { canEnviarComandoSms, parseUserRole } from '@/lib/roles';
import { StatusVeiculoPanel } from '@/components/StatusVeiculoPanel';
...
export function MonitoramentoPanel() {
  ...
  const role = parseUserRole(getUser()?.role);
          ...
          <>
            ...
            <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-2">
              <div className="p-4 space-y-4 overflow-y-auto bg-white border-r border-slate-200">
                ...
                {mostrarChips ? <ChipsPanel podeEditar={role === 'ADMIN'} placaPadrao={selecionado.placa} /> : null}
